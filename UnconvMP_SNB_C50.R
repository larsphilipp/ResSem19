...
# Pattern to describe next Week's CHFEUR
currentFxSMI <- allPeriodsC5(allData[currentFxSMIColumns], "CHFEURdir")
currentFxSMIM  <- allPeriodsC5(allData[currentFxSMIMColumns], "CHFEURdir")
currentFxSPIEX <- allPeriodsC5(allData[currentFxSPIEXColumns], "CHFEURdir")

# Pattern to describe next Week's CHFEUR
forecastFxSMI   <- allPeriodsC5(allData[forecastFxSMIColumns], "CHFEURnext")
forecastFxSMIM  <- allPeriodsC5(allData[forecastFxSMIMColumns], "CHFEURnext")
forecastFxSPIEX <- allPeriodsC5(allData[forecastFxSPIEXColumns], "CHFEURnext")
